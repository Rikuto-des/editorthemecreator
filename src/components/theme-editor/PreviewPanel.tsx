...
interface CodeToken {
  text: string
  type: 'comment' | 'string' | 'number' | 'keyword' | 'function' | 'class' | 'variable' | 'operator' | 'property' | 'constant' | 'parameter' | 'tag' | 'attribute' | 'regexp' | 'escape' | 'plain'
}
...
const SAMPLE_TOKENS: CodeToken[] = [
  ...
  { text: ' ', type: 'plain' },
  { text: 'MAX_COUNT', type: 'constant' },
  { text: ' = ', type: 'plain' },
  { text: '100', type: 'number' },
  { text: ';\n', type: 'plain' },
  { text: 'const', type: 'keyword' },
  { text: ' ', type: 'plain' },
  { text: 'pattern', type: 'variable' },
  { text: ' = ', type: 'plain' },
  { text: '/\\d+/', type: 'regexp' },
  { text: ';\n\n', type: 'plain' },
